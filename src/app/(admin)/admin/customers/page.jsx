  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-semibold tracking-tight text-[#3A3241]">Customers</h1>
          <p className="text-[#7F677A] mt-1 text-sm font-medium">View and manage your customer accounts.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-[#e9b0a1]/20 overflow-hidden">
        <div className="p-6 border-b border-[#e9b0a1]/20 flex items-center justify-between gap-4">
          ...
          <button 
            onClick={() => handleAction('Filter Customers')}
        ...
        <div className="p-20 flex flex-col items-center justify-center text-center bg-[#fff3ee]/10">
          ...
          <h3 className="text-xl font-semibold text-[#3A3241] mb-2">No customers yet</h3>
          <p className="text-[#7F677A] text-sm max-w-sm leading-relaxed">When users create accounts or make purchases, their details will be listed here. This page is ready for API integration.</p>
        </div>
      </div>
    </div>
  );
